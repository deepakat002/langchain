...
### other models: https://docs.anthropic.com/en/docs/about-claude/models/overview

print(f"----------claude-sonnet-4-20250514 loaded -------------- ")
...
def save_history_to_txt(history: list, filepath: str = "3_chat_history.txt"):
    with open(filepath, "w", encoding="utf-8") as f:
        for msg in history:
            role = msg.type.upper()
            f.write(f"{role}: {msg.content}\n\n")

def load_history_from_txt(filepath: str = "3_chat_history.txt"):
    try:
